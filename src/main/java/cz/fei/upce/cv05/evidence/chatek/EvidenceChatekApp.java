...
public class EvidenceChatekApp {
    ...
    private static void pridejNavstevnika() { 
        ...
        if (pridejNavstevnikyChatky(indexChatky, pocetNavstevniku) == false)
            System.err.println("Nelze pridat");            
    }
    ...
    private static boolean pridejNavstevnikyChatky(
            int chatka,int pocetNavstevniku) {
